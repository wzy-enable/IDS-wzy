...
# ratio={0:56000,1:40000,2:33393,3:18184,4:12264,5:10491,6:10000,7:10000,8:10000,9:10000}
...
list_index = [i for i in range(0,493954)]
np.random.shuffle(list_index)
rs = ShuffleSplit(n_splits=1, test_size=0.3, random_state=2)
for train_1,train_2 in rs.split(data_train[list_index]):
